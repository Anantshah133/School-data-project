...
<body>
    ...
    <main  class="poster-main" id="poster">
        <div class="poster position-relative">
            <div class="poster-section ">
                <div class="poster-heading   ">
                    <h2 class="poppins">MY GOAL</h2>
                </div>
                <div class="star-marks position-absolute">
                    ...
                    <h2 class="actual-marks" id="student-percentage" style="font-size : 50px !important;">100%</h2>
                </div>
                <div class="confetti">
                ...
                <div class="poster-middle d-flex justify-content-between ">
                    ...
                    <div class="profile-name">
                        ...
                        <div class="standard position-relative">
                            <span class=" poppins badge rounded-pill bg-danger">Education</span>
                            <h2 class="poppins position-relative" id="student-education">10 TH STD</h2>
                        </div>
                        <div class="standard3 position-relative">
                            <span class=" poppins badge rounded-pill bg-danger">School</span>
                        ...
                        <div class="standard2 position-relative ">
                            <span class="poppins badge rounded-pill bg-danger">
                                I will speak this lines <br/>  everyday</span>
    ...
    <div class="d-flex items-center justify-center mt-40 mb-40  " onclick="downloadImage('main-poster')">
        <button type="button" class="down-btn border-0 button-54 bg-danger" onclick="captureScreenshot()">
            <p class="p-0 m-0 fw-bold fs-3">Download</p>
        </button>
    </div>
    ...
    <script>
        ...
        function captureScreenshot() {
            ...
            // Set the viewport size to maintain a 16:9 aspect ratio suitable for Instagram posts
            setViewportSize(1600, 900);

            // Use html2canvas to capture the screenshot of the entire webpage
            html2canvas(document.body).then(function(canvas) {
                ...
                downloadLink.download = 'student_result.png';
                document.body.appendChild(downloadLink);
                downloadLink.click();
                document.body.removeChild(downloadLink);

                // Reset the viewport size to the original
                resetViewportSize();
        ...
        // Function to reset viewport size
    ...
    <script>
        // let mainPoster = document.getElementById("main-poster");
        ...
        document.addEventListener("DOMContentLoaded", ()=>{
            ...
            if(studentData){
                ...
                education.innerHTML = `${studentData.std}th ${studentData.stream || ''}`
                let content = "";
                let sum = 0;
